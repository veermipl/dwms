    ...
    $(".table").on("click", ".editbutton", function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#editAppointmentForm').find('[name="date"]').val(response.appointment.date).trigger('change');
                ...
                $('#editAppointmentForm').find('[name="location_id"]').val(response.appointment.location_id).end()
                $('#editAppointmentForm').find('[name="mode_of_consultation"]').val(response.appointment.mode_of_consultation).end()
                $('#editAppointmentForm').find('[name="type_of_consultation"]').val(response.appointment.type_of_consultation).end()
...
$(document).ready(function () {
    ...
    var table = $('#editable-sample6').DataTable({
        ...
        "searchable": true,
        "ajax": {
            url: "appointment/getNoShowAppointmentList",
            type: 'POST',
        },
        scroller: {
            loadingIndicator: true
...
$(document).ready(function () {
    ...
    var table = $('#editable-sample2').DataTable({
        ...
        "searchable": true,
        "ajax": {
            url: "appointment/getApprovedAppoinmentList",
            type: 'POST',
        },
        scroller: {
            loadingIndicator: true
...
$(document).ready(function () {
    ...
    var table = $('#editable-sample3').DataTable({
        ...
        "searchable": true,
        "ajax": {
            url: "appointment/getRejectedAppoinmentList",
            type: 'POST',
        },
        scroller: {
            loadingIndicator: true
...
$(document).ready(function () {
    ...
    var table = $('#editable-sample4').DataTable({
        ...
        "searchable": true,
        "ajax": {
            url: "appointment/getCompletedAppoinmentList",
            type: 'POST',
        },
        scroller: {
            loadingIndicator: true
...
$(document).ready(function () {
    "use strict";
    var table = $('#editable-sample7').DataTable({
        responsive: true,
        ...
        "searchable": true,
        "ajax": {
            url: "appointment/getPostponeAppoinmentList",
            type: 'POST',
        },
        scroller: {
            loadingIndicator: true
...
$(document).ready(function () {
    "use strict";
    var table = $('#editable-sample8').DataTable({
        responsive: true,
...
$(document).ready(function () {
    "use strict";
    var table = $('#editable-sample9').DataTable({
        responsive: true,
...
$(document).ready(function () {
    "use strict";
    var table = $('#editable-samplepending').DataTable({
        responsive: true,
        ...
        "searchable": true,
        "ajax": {
            url: "appointment/getAllCancelledAppointmentsByPending",
            type: 'POST',
        },
        scroller: {
            loadingIndicator: true
...
$(document).ready(function () {
    "use strict";
    var table = $('#editable-samplepostponed').DataTable({
        responsive: true,
...
$(document).ready(function () {
    "use strict";
    var table = $('#editable-sample10').DataTable({
        responsive: true,
        ...
        "searchable": true,
        "ajax": {
            url: "appointment/getVipAppoinmentList",
            type: 'POST',
        },
        scroller: {
            loadingIndicator: true
