...
$(document).ready(function () {
    ...
    $(".table").on("click", ".editPrescription", function () {
        ...
        $('#myModal5').modal('show');
        $.ajax({
            url: 'dispatches/editDispatchesByJason?id=' + iid,
            method: 'GET',
            data: '',
            dataType: 'json',
...
$(document).ready(function () {
    "use strict";
    var table = $('#editable-sample21').DataTable({
        responsive: true,
        //   dom: 'lfrBtip',
        ...
        "searchable": true,
        "ajax": {
            url: "dispatches/getDispatchesList",
            type: 'POST',
        },
        scroller: {
...
$(document).ready(function () {
    "use strict";
    var table = $('#editable-sample-pending21').DataTable({
        responsive: true,
        //   dom: 'lfrBtip',
        ...
        "searchable": true,
        "ajax": {
            url: "dispatches/getDispatchesPendingList",
            type: 'POST',
        },
        scroller: {
            loadingIndicator: true
