            ...
            <div class="modal-body">
                <form role="form" action="featured/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control ckeditor" name="description" id="editor" value='' placeholder=""> </textarea>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editFeaturedForm" class="clearfix" action="featured/addNew" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1"><?php echo lang('description'); ?></label>
                        <textarea type="text" class="form-control ckeditor editor" id="editor1" name="description"  value='' placeholder=""> </textarea>
                    </div>
                    <div class="form-group last">
                        <label class="control-label">Image Upload</label>
                        <div class="">
