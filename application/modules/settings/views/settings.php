                    ...
                    <div class="clearfix row">
                        ...
                        <form role="form" action="settings/update" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-12">
                             <span><b>Booking Setting :</span></b></div>
                             <div class="form-group col-md-6">
                           ...
                           <!-- <div class="form-group col-md-12"> 
                            ...
                            <input type="checkbox" class="width" name="unpaid_appointment"  value='1' <?php
                                if ($settings->unpaid_appointment=='1') { ?>
                                    checked
                               <?php } ?>>    
                            ...
                            <div class="form-group col-md-4">
                             ...
                             <input type="checkbox" class="width" name="allow_client"  
                                value='1' <?php
                                if ($settings->allow_client=='1') { ?>
                                    checked
                               <?php } ?>> 
