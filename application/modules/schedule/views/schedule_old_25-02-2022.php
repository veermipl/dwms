            ...
            <div class="modal-body row">
                <form role="form" action="schedule/addSchedule" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control m-bot15" id="weekday" name="weekday" value=''> 
                           <option value="">Select .....</option>
                            <?php foreach ($weekday as $week) { ?>
                            <?php 
                            if($_SESSION['weekday'] == $week->name){?>
                            <option value="<?php echo $week->name; ?>" selected><?php echo $week->name; ?></option>

                            }else
                            {
                            ?>
                            <option value="<?php echo $week->name; ?>"><?php echo $week->name; ?></option>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control m-bot15" id="location" name="location" value=''> 
                           <option value="">Select .....</option>
