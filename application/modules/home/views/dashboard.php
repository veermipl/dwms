                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" title="Pending Appointments" href="#">
                            ...
                            <span class="badge bg-success">
                                ...
                                if ($this->ion_auth->in_group('Doctor')) {
                                    ...
                                    $query = $this->db->where('doctor', $doctor_id);
                                }
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" title="Number Of Cancellation Requests" href="#">
                            ...
                            <span class="badge bg-success">
                                ...
                                if ($this->ion_auth->in_group('Doctor')) {
                                    ...
                                    $appQuery = $this->db->select('id')->where('doctor', $doctor_id)->get('appointment');

                                    $resultArray = $appQuery->result_array();
                                    $allApptId = array_column($resultArray, 'id');
                                }

                                $query = $this->db->where('type', 8);
                                $query = $this->db->where('flag', 0);
                                if ($allApptId && count($allApptId) > 0) {
                                    $query = $this->db->where_in('appointment_id', $allApptId);
                                }
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                        ...
                        <li class="sub-menu">
                            <a href="diagnos">
                                <i class="fa fa-building"></i>
                                <span><?php echo lang('diagnos'); ?></span>
                            </a>
                        </li>
                    ...
                    <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li style="display:none"><a href="schedule/allHolidays"><i class="fa fa-list-alt"></i><?php echo lang('holidays'); ?></a></li>
                    ...
                    ?>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li style="display:none"><a href="schedule/holidays"><i class="fa fa-list-alt"></i><?php echo lang('holidays'); ?></a></li>
                    ...
                    <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <!-- <li><a href="pgateway"><i class="fa fa-credit-card"></i><?php //echo lang('payment_gateway'); 

                                                                                                ?></a></li> -->

                                <!-- <li><a href="settings/language"><i class="fa fa-language"></i><?php //echo lang('language'); 
