                ...
                <div class="adv-table editable-table ">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th style="width:100px ! important;"><?php echo lang('date'); ?></th>
                                <th style="width:300px ! important;"><?php echo lang('message'); ?></th>
                                <th style="width:400px ! important;"><?php echo lang('recipient'); ?></th>
                                <th style="width:100px ! important;"><?php echo lang('options'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
