    ...
    function book_appointment() {
        ...
        //  $userdata =  $this->ion_auth->where('id',$userid)->users()->result();
                ...
                (
                    ...
                    'body'     => 'You got a new booking request #'.$result_data[0]->id .' for '.$this->input->post('date').' '.$this->input->post('time_slot').'.',
                );
                $data_addedd = array
                (
                    'type'   => 'BKNG',
                    ...
                    'msg'  => 'You got a new booking request #'.$result_data[0]->id .' for '.$this->input->post('date').' '.$this->input->post('time_slot').'.',
                );
...
function getPatientByDoctorIdbyjason() {
    ...
    public function vip_slot_date(){
        ...
        foreach($period as $date) {	
            if (date('l', strtotime($date->format('Y-m-d')))==$time_slot_data[0]->weekday) {
