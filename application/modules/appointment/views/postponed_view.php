                                ...
                                <div class="adv-table editable-table ">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="myTable">
                                        ...
                                        <tbody>
                                            ...
                                            <td><?php $patientdetails = $this->patient_model->getPatientById($value->patient); echo $patientdetails->name; ?></td>
                                            ...
                                            ?> </td>
                                            <td> <a class="btn btn-info btn-xs btn_width" href="appointment/viewAppointment?id=<?php echo $value->id?>"><i class="fa fa-eye"><?php echo lang('view') . ' ' . lang('appointment')?> </i></a></td>
                                            </tr>
                                            <?php 
                        ...
                        <div class="">
                            <div class="panel-body">
                                <div class="adv-table editable-table">
                                    ...
                                    <div class="space15"></div>
                                    <table class="table table-striped table-hover table-bordered" id="editable-samplepostponed">
                                        <thead>
                                            <tr>
                                                <th> <?php echo lang('id'); ?></th>
                                                <th> <?php echo lang('patient'); ?></th>
