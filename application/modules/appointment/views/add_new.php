                ...
                <form role="form" action="appointment/addNew" class="clearfix row" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4 panel">
                            ...
                            <div class="col-md-12 doctor_div pd-0">
                        ...
                        <div class="col-md-12 panel">
                            ...
                            <div class="col-md-4 panel pdl-5">
                            ...
                            <div>
                                ...
                                <div class="col-md-12 " style="display: none;">
                                    ...
                                    <input type="number" step="0.01" class="form-control" id="numberInput" name="amount" value="<?= set_value('amount', @$appointment->amount ?? '') ?>" />
