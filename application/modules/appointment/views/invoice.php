        ...
        <table cellpadding="0" cellspacing="0" style="width: 100%; line-height: inherit; text-align: left;">
            <tr class="top_rw">
                ...
                <td style="padding: 15px 15px 10px 15px; text-align: right;">
                    <h2 style="margin-bottom: 0px; margin-top: 0; color: #2ea2d9;
                     font-size: 24px;">
                        Invoice </h2>
                </td>
            </tr>
            ...
            <tr>
                <td style="padding: 15px 15px 10px;">
                    <table style="width:100%">
                        <tbody>
                            <tr>
                                <td style="color: #2ea2d9;font-size: 20px;font-weight: 700;">BILL TO :</td>
                            </tr>
                        </tbody>
                    </table>
                </td>
            ...
            <tr class="details" style="width: 100%;">
                <td colspan="3" style="padding: 15px 15px 5px; width: 100%;">
                    <table cellspacing="0px" cellpadding="2px" style="width: 100%;">
                        <tr class="heading" bgcolor="#2ea2d9" style="background-color: #2ea2d9!important;color: #fff; font-weight: bold; font-size: 12px;width: 100%;">
                            <td style="width:50%; text-align:center;padding:5px 10px;border-left: 1px solid #000;border-bottom: 1px solid #000;border-top: 1px solid #000;">
                                Appointment Details
                            </td>
                            <td style="width:15%;padding: 5px 10px; text-align:center;border-left: 1px solid #000;border-top: 1px solid #000;border-bottom: 1px solid #000;">
                                Unit Price ($)
                            </td>
                            <td style="width:10%;padding: 5px 10px; text-align:center;border-top: 1px solid #000;border-left: 1px solid #000;border-bottom: 1px solid #000;">
                                QTY
                            </td>
                            <td style="width:20%;padding: 5px 10px; text-align:center; border-top: 1px solid #000;border-left: 1px solid #000;border-bottom: 1px solid #000;border-right: 1px solid #000;">
                                Amount ($)
                            </td>
                        </tr>
                        ...
                        <tr class="item">
                           ...
                           font-size: 14px;border-bottom: 1px solid #000;border-left: 1px solid #000;" colspan="3">
                                Sub Total
                            </td>
                            <td style="width:15%; text-align:center;font-weight: 600;
                           color: #273477;
            ...
            <tr class="total">
                <td colspan="3" style="padding: 15px 15px 5px;color: #2ea2d9; text-transform: uppercase;font-weight: 700;font-size: 16px;">
                    <b>Other Comments :</b>
                </td>
            </tr>
            <tr>
            ...
            <tr style="text-align:center;">
                <td style="padding: 15px 15px 5px;color: #222222f7;    font-weight: 600;
                  line-height: 18px;" colspan="3">
                    If you have any questions about this invoice,<br />please contact DWMS
                </td>
            </tr>
            <tr style="text-align:center;">
                <td style="padding: 5px 15px 15px;color:  #2ea2d9;    font-size: 18px;  font-weight: 600;
                  line-height: 18px;" colspan="3">
                    Thank you
                </td>
            </tr>
