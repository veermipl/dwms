...
class Finance_model extends CI_model
{
    ...
    function thisMonthAppointment()
    {
        ...
        foreach ($query as $q) {
            ...
            if (date('m/Y', time()) == date('m/Y', strtotime($q->date))) {
    ...
    function thisDayAppointment()
    {
        ...
        foreach ($query as $q) {
            ...
            if (date('d/m/Y', time()) == date('d/m/Y', strtotime($q->date))) {
    ...
    function thisYearAppointment()
    {
        ...
        foreach ($query as $q) {
            ...
            if (date('Y', time()) == date('Y', strtotime($q->date))) {
    ...
    function getThisMonth()
    {
        ...
        foreach ($appointments as $appointment) {
            ...
            if (date('m/y', strtotime($appointment->date)) == date('m/y', time())) {
