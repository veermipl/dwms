                                    ...
                                    <tr class="">
                                        ...
                                        <td  class="no-print"> 
                                            ...
                                            <?php if ($this->ion_auth->in_group(array('admin', 'Accountant'))) { ?> 
                                                ...
                                                <a class="btn-xs btn-info delete_button edit_pay" title="<?php echo lang('delete'); ?>"   href="finance/delete?id=<?php echo $payment->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i> </a>
