                ...
                <section class="">
                    ...
                    <div class="user-heading round edit_patient_div">
                        ...
                        <?php if (!$this->ion_auth->in_group(array('Patient','Doctor'))) { ?>
                            <a class="btn btn-info btn-xs" href="patient/editPatient?id=<?=$patient->id?>"><i class="fa fa-edit"> </i> <?php echo lang('edit'); ?></a>
                            <!-- <button type="button" class="btn btn-info btn-xs editPatient" title="<?php echo lang('edit'); ?>" data-toggle="modal" data-id="<?php echo $patient->id; ?>"><i class="fa fa-edit"> </i> <?php echo lang('edit'); ?></button> -->
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li> <?php echo lang('patient_id'); ?> : <span class="label r-activity"><?php echo $patient->id; ?></span></li>

                        <li> <?php echo lang('gender'); ?> : <span class="label r-activity"><?php echo $patient->sex; ?></span></li>

                        <li> <?php echo lang('birth_date'); ?> : <span class="label r-activity"><?php echo $patient->birthdate; ?></span></li>

                        <li> <?php echo lang('phone'); ?> : <span class="label r-activity"><?php echo $patient->phone; ?></span></li>

                        <li> <?php echo lang('email'); ?> : <span class="label r-activity"><?php echo $patient->email; ?></span></li>

                        <li class="address_bar"> <?php echo lang('address'); ?> : <span class=" address_bar"><?php echo $patient->address; ?></span></li>
        ...
        <div class=" modal-content">
            ...
            <div class="modal-body">
                ...
                <form role="form" id="editAppointmentForm" class="clearfix row" action="appointment/addNew" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6 mb-3 doctor_div1">
            ...
            <div class="modal-body row">
                ...
                <form role="form" id="editPatientForm" action="patient/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" required name="name" id="exampleInputEmail1" value='' placeholder="">
