                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <label class="radio-inline pt-3 pb-2 col-md-6">
                                                                <input readonly disabled type="radio" name="idType" value="passport" <?= (set_value('idType', @$patientData->idType) == 'passport') ? 'checked' : '' ?>>
                                                                Passport number
                                                            </label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <label class="radio-inline  pt-3 pb-2 ">
                                                                <input readonly disabled type="radio" name="idType" value="drivers" <?= (set_value('idType', @$patientData->idType) == 'drivers') ? 'checked' : '' ?>>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <label class="radio-inline pt-3  pb-2 ">
                                                                <input readonly disabled type="radio" name="idType" value="other" <?= (set_value('idType', @$patientData->idType) == 'other') ? 'checked' : '' ?>>
                                                                Other
                                                            </label>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <label class="radio-inline">
                                                            <input readonly disabled type="radio" name="allergies" value="yes" <?= (set_value('allergies', @$patientData->allergies) == 'yes') ? 'checked' : '' ?>>
                                                            Y
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input readonly disabled type="radio" name="allergies" value="no" <?= (set_value('allergies', @$patientData->allergies) == 'no') ? 'checked' : '' ?>>
                                                            N
                                                        </label>
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <label class="radio-inline">
                                                            <input readonly disabled type="radio" name="smoking" value="yes" <?= (set_value('smoking', @$patientData->smoking) == 'yes') ? 'checked' : '' ?>>
                                                            Y
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input readonly disabled type="radio" name="smoking" value="no" <?= (set_value('smoking', @$patientData->smoking) == 'no') ? 'checked' : '' ?>>
                                                            N
                                                        </label>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <label class="radio-inline">
                                                            <input readonly disabled type="radio" name="alcohol" value="yes" <?= (set_value('alcohol', @$patientData->alcohol) == 'yes') ? 'checked' : '' ?>>
                                                            Y
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input readonly disabled type="radio" name="alcohol" value="no" <?= (set_value('alcohol', @$patientData->alcohol) == 'no') ? 'checked' : '' ?>>
                                                            N
                                                        </label>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <label class="radio-inline">
                                                            <input readonly disabled type="radio" name="other_activity" value="yes" <?= (set_value('other_activity', @$patientData->other_activity) == 'yes') ? 'checked' : '' ?>>
                                                            Y
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input readonly disabled type="radio" name="other_activity" value="no" <?= (set_value('other_activity', @$patientData->other_activity) == 'no') ? 'checked' : '' ?>>
                                                            N
                                                        </label>
                                                    </div>
