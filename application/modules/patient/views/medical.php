...
<?php if ($this->ion_auth->in_group(array('Nurse', 'Doctor', 'admin'))) : ?>
                    ...
                    <div class="panel-body">
                        <div class="mt-3">
                            <ul class="nav nav-tabs nav-tabs-custom" role="tablist">
                                ...
                                <?php if ($this->ion_auth->in_group(array('Doctor', 'admin')) || (($appointmentData->mode_of_consultation == '1') && ($this->ion_auth->in_group(array('Nurse'))))) : ?>
                        ...
                        <div class="tab-content">
                                        ...
                                        <?php if ($this->ion_auth->in_group(array('Nurse'))) : ?>
                                            <div class="col-md-12">
                                                <div class="form-group text-right">
                                                    <a href="appointment/editAppointment?id=<?= $apid ?>" class="btn btn-primary" title=""> <i class="fa fa-edit"></i> Edit Appointment</a>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                            ...
                            <?php if ($this->ion_auth->in_group(array('Doctor', 'admin'))) : ?>
                                <div class="tab-pane <?= ($patient_form_tab == 'general') ? 'active' : '' ?>" id="overview" role="tabpanel">
                                    <div class="card">
                                        <div class="card-body p-4">
                                            <form role="form" action="patient/UpdateGeneralForm" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <select class="form-control m-bot15" name="sex" value='' readonly disabled>
                                                            <option value="Male" <?= set_value('sex', @$patientData->sex) == 'Male' ? 'selected' : '' ?>>
                                                                Male </option>
                                                            <option value="Female" <?= set_value('sex', @$patientData->sex) == 'Female' ? 'selected' : '' ?>>
                                                                Female </option>
                                                            <option value="Others" <?= set_value('sex', @$patientData->sex) == 'Others' ? 'selected' : '' ?>>
                                                                Others </option>
                                                        </select>
                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <label class="radio-inline pt-3 pb-2 col-md-6">
                                                                            <input type="radio" name="idType" value="passport" <?= (set_value('idType', @$patientData->idType) == 'passport') ? 'checked' : '' ?>>
                                                                            Passport number
                                                                        </label>
                                                                        <input type="text" class="form-control" name="idType_passport" value="<?= set_value('idType_passport', @$patientData->idType_passport) ?>">

                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <label class="radio-inline  pt-3 pb-2 ">
                                                                            <input type="radio" name="idType" value="drivers" <?= (set_value('idType', @$patientData->idType) == 'drivers') ? 'checked' : '' ?>>
                                                                            Driver’s license number
                                                                        </label>
                                                                        <input type="text" class="form-control" name="idType_drivers" value="<?= set_value('idType_drivers', @$patientData->idType_drivers) ?>">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <label class="radio-inline pt-3  pb-2 ">
                                                                            <input type="radio" name="idType" value="other" <?= (set_value('idType', @$patientData->idType) == 'other') ? 'checked' : '' ?>>
                                                                            Other
                                                                        </label>
                                                                        <input type="text" class="form-control" name="idType_other" value="<?= set_value('idType_other', @$patientData->idType_other) ?>">

                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label class="pt-3  pb-2" for="exampleInputEmail1"><?php echo lang('address'); ?><span class="text-danger">*</span></label>
                                                                            <input type="text" class="form-control" name="address" value='<?= set_value('address', @$patientData->address) ?>' placeholder="">
                                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" id="chiefComplaint" name="chiefComplaint"><?= set_value('chiefComplaint', @$patientData->chiefComplaint) ?></textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="historyOfIllness">History of Presenting Illness:</label>
                                                                <textarea class="form-control" id="historyOfIllness" name="historyOfIllness"><?= set_value('historyOfIllness', @$patientData->historyOfIllness) ?></textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="pastMedicalHistory">Past Medical History and Drug
                                                                    History:</label>
                                                                <textarea class="form-control" id="pastMedicalHistory" name="pastMedicalHistory"><?= set_value('pastMedicalHistory', @$patientData->pastMedicalHistory) ?></textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="pastSurgicalHistory">Past Surgical History:</label>
                                                                <textarea class="form-control" id="pastSurgicalHistory" name="pastSurgicalHistory"><?= set_value('pastSurgicalHistory', @$patientData->pastSurgicalHistory) ?></textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Allergies:</label>
                                                                <div>
                                                                    <label class="radio-inline">
                                                                        <input type="radio" name="allergies" value="yes" <?= (set_value('allergies', @$patientData->allergies) == 'yes') ? 'checked' : '' ?>>
                                                                        Y
                                                                    </label>
                                                                    <label class="radio-inline">
                                                                        <input type="radio" name="allergies" value="no" <?= (set_value('allergies', @$patientData->allergies) == 'no') ? 'checked' : '' ?>>
                                                                        N
                                                                    </label>
                                                                </div>
                                                                <textarea class="form-control mt-2" id="allergies_comment" name="allergies_comment" placeholder="Comment"><?= set_value('allergies_comment', @$patientData->allergies_comment) ?></textarea>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div>
                                                                    <label class="radio-inline">
                                                                        <input type="radio" name="smoking" value="yes" <?= (set_value('smoking', @$patientData->smoking) == 'yes') ? 'checked' : '' ?>>
                                                                        Y
                                                                    </label>
                                                                    <label class="radio-inline">
                                                                        <input type="radio" name="smoking" value="no" <?= (set_value('smoking', @$patientData->smoking) == 'no') ? 'checked' : '' ?>>
                                                                        N
                                                                    </label>
                                                                </div>
                                                                <textarea class="form-control mt-2" id="smoking_comment" name="smoking_comment" placeholder="Comment"><?= set_value('smoking_comment', @$patientData->smoking_comment) ?></textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Alcohol use:</label>
                                                                <div>
                                                                    <label class="radio-inline">
                                                                        <input type="radio" name="alcohol" value="yes" <?= (set_value('alcohol', @$patientData->alcohol) == 'yes') ? 'checked' : '' ?>>
                                                                        Y
                                                                    </label>
                                                                    <label class="radio-inline">
                                                                        <input type="radio" name="alcohol" value="no" <?= (set_value('alcohol', @$patientData->alcohol) == 'no') ? 'checked' : '' ?>>
                                                                        N
                                                                    </label>
                                                                </div>
                                                                <textarea class="form-control mt-2" id="alcohol_comment" name="alcohol_comment" placeholder="Comment"><?= set_value('alcohol_comment', @$patientData->alcohol_comment) ?></textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="other">Other (Sexual activity, LMP, etc.):</label>
                                                                <div>
                                                                    <label class="radio-inline">
                                                                        <input type="radio" name="other_activity" value="yes" <?= (set_value('other_activity', @$patientData->other_activity) == 'yes') ? 'checked' : '' ?>>
                                                                        Y
                                                                    </label>
                                                                    <label class="radio-inline">
                                                                        <input type="radio" name="other_activity" value="no" <?= (set_value('other_activity', @$patientData->other_activity) == 'no') ? 'checked' : '' ?>>
                                                                        N
                                                                    </label>
                                                                </div>
                                                                <textarea class="form-control mt-2" id="other_activity_comment" name="other_activity_comment" placeholder="Comment"><?= set_value('other_activity_comment', @$patientData->other_activity_comment) ?></textarea>
                                                            </div>
                                                        </div>
                                                ...
                                                <input type="hidden" name="p_id" value='<?php
                                                                                        if (!empty($patientData->patient_id)) {
                                                                                            echo $patientData->patient_id;
                                                                                        }
                                                                                        ?>'>
                                                <?php if ($this->ion_auth->in_group(array('Doctor'))) : ?>
                                    ...
                                    <form role="form" action="appointment/updateApppinmentPhyscialDetail" method="post" enctype="multipart/form-data">
                                            ...
                                            <table class="table table-bordered" style="width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="radio" name="physical_eyes_pupils" <?php if ($data->physical_eyes_pupils == 'abnormal') echo 'checked'; ?> value="abnormal"></td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <div class="class">
                                            <table class="table table-bordered" style="width: 100%;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><textarea class="form-control" name="physical_diagnosis_comment" id="comments" rows="4"><?= $data->physical_diagnosis_comment ?></textarea>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="radio" name="physical_investigation" <?php if ($data->physical_investigation == 'No') echo "checked"; ?> value="No"></td>
                                                        <td><input type="radio" name="physical_investigation" <?php if ($data->physical_investigation == 'NA') echo "checked"; ?> value="NA"></td>
                                                        <td><textarea class="form-control" name="physical_investigation_comment" id="comments" rows="4"><?= $data->physical_investigation_comment ?></textarea>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><textarea class="form-control" id="comments" name="physical_treatment_procedure_comment" rows="4"><?= $data->physical_treatment_procedure_comment ?></textarea>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><textarea class="form-control" id="comments" name="physical_patient_educated_comment" rows="4"><?= $data->physical_patient_educated_comment ?? '' ?></textarea>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><textarea class="form-control" name="physical_sick_leave_comment" id="comments" rows="4"><?= $data->physical_sick_leave_comment ?? '' ?></textarea>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><textarea class="form-control" name="physical_follow_up_comment" id="comments" rows="4"><?= $data->physical_follow_up_comment ?? '' ?></textarea>
                                                        </td>
                                                    </tr>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="physical_physician_name" value="<?= $data->physical_physician_name ?? ucwords($doctor->name) ?>">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <?php if ($this->ion_auth->in_group(array('Doctor'))) : ?>
                                            <div class="form-group">
                                                <label for="exam_complete">Examination Completed</label>
                                                <input type="checkbox" name="exam_complete" class="" <?= ($data->exam_complete == '1') ? 'checked' : '' ?>>
                                            </div>
                                            <?php endif; ?>

                                            <?php if ($this->ion_auth->in_group(array('Doctor')) || (($appointmentData->mode_of_consultation == '1') && ($this->ion_auth->in_group(array('Nurse'))))) : ?>
                                                <div class="form-group">
                                                    <input type="submit" name="submit" value="Submit" class="btn btn-primary" style="background:#097eb8 !important;border: unset;">
                                                </div>
                                            <?php endif; ?>
