    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <?php echo 'Dispatched List'; ?> 

                <a href='dispatches/pending' class="btn btn-primary" style="margin-left: 860px ! important;" role="button">Pending Dispatch List</a>
            ...
            <div class="panel-body">
                <div class="adv-table editable-table ">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample21">
                        <thead>
                            <tr>
                                <th> <?php echo 'Prescription ID'; ?></th>       
