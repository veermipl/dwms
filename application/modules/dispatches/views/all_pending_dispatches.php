...
$query = $this->dispatches_model->updateVisitStatus();
    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <?php echo 'All Pending Dispatch List'; ?>
                <a href='dispatches/all' class="btn btn-primary" style="margin-left: 860px ! important;" role="button"> Dispatch List</a>
            ...
            <div class="panel-body">
                <div class="adv-table editable-table ">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample-pending21">
                        <thead>
                            <tr>
                                <th> <?php echo 'Prescription ID'; ?></th>                                <th> <?php echo lang('doctor'); ?></th>
                                <th> <?php echo lang('patient'); ?></th>
                               <!--  <th> <?php echo 'Dispatched Status'; ?></th> -->
...
<script src="common/extranal/js/prescription/all_dispatches.js"></script>