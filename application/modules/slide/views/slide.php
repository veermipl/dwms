            ...
            <div class="modal-body">
                <form role="form" action="slide/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="text1"  value='' placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1"><?php echo lang('text2'); ?></label>
                        <input type="text" class="form-control" name="text2"  value='' placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1"><?php echo lang('text3'); ?></label>
                        <input type="text" class="form-control" name="text3"  value='' placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1"><?php echo lang('position'); ?></label>
                        <input type="text" class="form-control" name="position"  value='' placeholder="">
                    </div>
                    <div class="form-group">
