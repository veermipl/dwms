...
class Ion_auth
{
    ...
    public function __construct()
    {
        ...
        $this->load->helper(array('cookie', 'language', 'url', 'services'));
        ...
        if ($this->ion_auth_model->forgotten_password($identity)) {   //changed
            ...
            if ($user) {
                ...
                if (!$this->config->item('use_ci_email', 'ion_auth')) {
                    ...
                    if (_send_forget_email($user->email, $message, $settings->system_vendor . ' - ' . $this->lang->line('email_forgotten_password_subject'))) {
                        $this->set_message('forgot_password_successful');
                        return TRUE;
                    } else {
